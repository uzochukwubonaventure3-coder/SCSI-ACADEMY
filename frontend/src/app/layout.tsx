...
export const metadata: Metadata = {
  ...
  keywords:    ['SCSI Academy', 'mindset coaching Nigeria', 'student counseling', 'Eze Tochukwu Precious', 'leadership mentorship'],
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        {/* Paystack inline.js — loaded globally so it's available on ALL pages */}
        <Script
